...
@section('content')
    <div class="container mb-5 mt-5">
        <div class="row justify-content-center">
            ...
            <p>The FitMate website located at fitmate.heroku.com is a copyrighted work belonging to FitMate. Certain features of the Site may be subject to additional guidelines, terms, or rules, which will be posted on the Site in connection with such features.</p>
            ...
            <p>Address: University of Surrey</p>
            <p>Email: jg01386@surrey.ac.uk</p>/
        </div>
    </div>
@endsection
